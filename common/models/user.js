		...
		'updatePassword',
		  {
		    ...
		    accepts: [
		      ...
		      {arg: 'oldPassword', type: 'string', required: false, description: "The user old password"},
		      {arg: 'newPassword', type: 'string', required: false, description: "The user new password"}
		    ],
